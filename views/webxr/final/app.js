...
const MODEL_SCALE = 1;
const MODEL_MRCAT_URL = 'https://AssetManager.azureedge.net/assets-v2/422921ad-81f1-46c7-80f2-7765c4c3fc70%5Clil_export_set.glb?7713ff81ffd1d4677ade591e212c38c29edd8a76f694360bd5f31ef82744b310cdb72cef2ff0677de17e7c87c56859b90203b4';
...
class App {
  ...
  async onSessionStarted(session) {
    ...
    if (loadGlb){
        DemoUtils.loadGLTF(MODEL_MRCAT_URL).then(gltf => {
